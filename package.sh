...
Priority: optional
Architecture: armhf
Depends: libc6, libreadline6, libssl1.0.0, libpcre3, libyaml-0-2, i2c-tools, libi2c-dev, libopencv-core2.4, libopencv-core-dev, libopencv-dev, libgsl0ldbl, libgsl0-dev, wiringpi
